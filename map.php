...
try{
    ...
    $sql= "SELECT t.tour_mountain, mt.mountain_name , t.tour_build ,m.mem_id ,m.mem_avator,t.tour_title,mt.mountain_latitude,mt.mountain_longitude,t.tour_activitystart
    FROM tour t
